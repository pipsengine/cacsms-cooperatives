      ...
      <section className="py-32 bg-white relative overflow-hidden border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              See the Cooperative Clearly, <br className="hidden md:block"/> Not Through Guesswork.
            </motion.h2>
            <p className="text-lg text-slate-600 font-medium">
              Every screen in CACSMS Coops is designed to give users visibility without overwhelming them. Turn complex operations into a clear and manageable digital experience.
            </p>
          </div>
          ...
          <motion.div 
            ...
            className="relative mx-auto max-w-5xl rounded-2xl bg-slate-100 border border-slate-200/60 shadow-2xl p-2 sm:p-4"
          >
             ...
             <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="h-12 bg-slate-50 border-b border-slate-100 flex items-center px-4 gap-4">
                   ...
                   <div className="flex-1 max-w-md bg-white border border-slate-200 rounded-md h-7 flex items-center px-3">
                ...
                <div className="flex h-[400px] sm:h-[500px]">
                   {/* Sidebar */}
                   <div className="hidden sm:block w-48 bg-slate-50 border-r border-slate-100 p-4 space-y-4">
                      <div className="space-y-2">
                        <div className="w-full h-8 bg-blue-100 rounded-md"></div>
                        <div className="w-3/4 h-8 bg-slate-200/50 rounded-md"></div>
                        <div className="w-5/6 h-8 bg-slate-200/50 rounded-md"></div>
                        <div className="w-4/5 h-8 bg-slate-200/50 rounded-md"></div>
                      </div>
                   </div>
                   {/* Main Frame */}
                   <div className="flex-1 p-6 bg-white overflow-hidden relative">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-8">
                         ...
                         <div className="border border-slate-100 rounded-xl p-4 shadow-sm">
                           <div className="w-16 h-3 bg-slate-200 rounded mb-4"></div>
                           <div className="w-32 h-8 bg-emerald-600 rounded"></div>
                         </div>
                         <div className="border border-slate-100 rounded-xl p-4 shadow-sm hidden md:block">
                           <div className="w-16 h-3 bg-slate-200 rounded mb-4"></div>
                           <div className="w-32 h-8 bg-slate-800 rounded"></div>
                         </div>
                      </div>
                      ...
                      <div className="border border-slate-100 rounded-xl overflow-hidden shadow-sm">
                         ...
                         {[1, 2, 3].map(i => (
                           <div key={i} className="h-14 border-b border-slate-50 flex items-center px-4 gap-4">
                             ...
                             <div className="w-1/4 h-3 bg-slate-800 rounded opacity-60"></div>
                             <div className="w-1/4 h-3 bg-slate-800 rounded opacity-60"></div>
                             <div className="w-1/4 h-5 bg-emerald-100 rounded-full"></div>
                           </div>
                         ))}
                      </div>
                      ...
                      <motion.div 
                        ...
                        className="absolute bottom-4 right-4 bg-slate-900 text-white p-4 rounded-xl shadow-2xl flex items-center gap-4"
                      >
                         <CheckCircle2 className="w-8 h-8 text-emerald-400" />
                         <div>
                           <div className="font-bold text-sm">Approvals Synced</div>
                           <div className="text-xs text-slate-400">Ledger updated successfully</div>
                         </div>
                      </motion.div>
                   </div>
                </div>
